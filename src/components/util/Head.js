  ...
  render() {
    return(
      <Helmet>
        ...
        data-cart-custom2-name="Mit der Bestellung akzeptieren Sie unsere AGBs. Diese können Sie <a target='_blank' rel='noopener noreferrer' href='https://www.selvii.de/rechtliches/agbs'>hier</a> nachlesen."
