...
export default class Accessoires extends React.Component {
  render() {
    ...
    return(
      <Wrapper>
        <Head title="Accessoires | Damenmode | Selvii Online Shop" desc="Endecken Sie die Selvii Kleider. Kleider für die Abendgarderobe oder Freizeit"/>
        <Header />
          <ProductCardWrapper>
...
export const pageQuery = graphql`
  query IndexQueryAccessoiresProducts {
    allMarkdownRemark(
